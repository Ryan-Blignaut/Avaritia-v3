...
public class LayeredModelTest implements IModelGeometry<LayeredModelTest>
{
	private final ImmutableSet<Integer> overlayLayers;
	private ImmutableList<Material> textures;

	public LayeredModelTest(ImmutableList<Material> textures, ImmutableSet<Integer> overlayLayers)
	{
	...
	{
		return isOverlay ? ModRenderLayers.getUnsortedTranslucent() : ForgeRenderTypes.ITEM_LAYERED_TRANSLUCENT.get();
	}
...
//		TODO: fix the topology as all parts of the mesh are now internally connected.
	...
	public static class Loader implements IModelLoader<LayeredModelTest>
	{
		public static final Loader INSTANCE = new LayeredModelTest.Loader();
		...
		@Override
		public LayeredModelTest read(JsonDeserializationContext deserializationContext, JsonObject modelContents)
		{
			...
			return new LayeredModelTest(null, overlayLayers.build());
		}
	}
